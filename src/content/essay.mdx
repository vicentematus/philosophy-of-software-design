...
Node’s API interface of <code>console.log</code> hides implementation details on how v8 engine works.
...
[^2]: You can't always eliminating shallow classes. Sometimes is the best you can do.

[^3]: John Ousterhout, "A Philosophy of Software Design" (2018). A refreshing contrarian perspective.

[^4]: This is the key insight: interface complexity vs implementation complexity ratio.
