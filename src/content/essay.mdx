...
But sometimes our design isn't the best. We were taught by popular demand and Uncle Bob (Clean Code) that classes should just do one thing.[^1]
...
However, John Ousterhout argues something different. He suggests that we should create "deep" classes—classes with simple interfaces that hide significant complexity.[^2]
