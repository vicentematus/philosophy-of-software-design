...
The biggest challenge in programming is understanding the systems we build. Larger programs and more developers increase complexity and difficulty in managing it.
...
But sometimes our design isn’t the best. We are taught by popular demand and Clean Code that classes should just do one thing.[^1]
...
However, John argues something different. He suggests that we should create "deep" classes with simple interfaces that hide significant complexity.
...
Node’s API interface of <code>console.log</code> hides implementation details on how stdout / stderr in V8 works.
...
Here's a common example of a shallow class that just passes through calls:[^2]
...
### Strategic approaches when designing 
...
There are two approaches to the design process: John calls them _tactical and _strategic_ programming.

</TimestampBlock>

#### Tactical programming

In the tactical approach, your main focus is to get something working. But isn't that the goal of programming? The problem is you are always looking for shortcuts, leaving tech debt behind.
...
In the strategic approach, *working code is not enough*. Your primary goal is to produce a great design, which also happens to work.
...
[^2]: You can't always eliminate shallow classes. Sometimes is the best you can do.


[^3]: Tactical tornado is short-sighted. 


[^4]: Strategic programmers are long-sighted. 
