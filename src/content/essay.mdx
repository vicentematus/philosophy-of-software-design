...
There are two approaches to the design process: John calls them _tactical_ and _strategic_ programming.
</TimestampBlock>
...
[^1]: John defines _complexity_ as "Anything related to the structure of a system that makes it hard to work on the development of that system"
